...
title: Mapbox Mobile
layout: project
permalink: /project/mapbox-mobile
cardimg: /work/cards/mapbox-mobile.jpg
work:
  images:
    - title: mapbox-mobile.jpg
      col: column12
---
...
.post-header {
  width: 100%;
  height:550px;
  background: url(../../work/header/mapbox-mobile.jpg) center top no-repeat;
